<template>
  <div>
    ...
    >
    <b-card-text>
      <b-input v-model="pinata.api_key" placeholder="pinata_api_key" />
      <b-input v-model="pinata.api_key_secret" placeholder="pinata_api_secret_key" />
      or
      <b-input v-model="pinata.jwt" placeholder="pinata_jwt" />
